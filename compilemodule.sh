...
sudo apt install libpcre2-dev libpcre3-dev gcc git make zlib1g-dev openssl libssl-dev -y
...
echo "Paste git compatible links here, then press Ctrl+D twice when done."
